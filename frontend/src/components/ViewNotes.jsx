          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base sm:text-lg font-semibold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent label-text truncate">
                  {noteTitle}
                </h1>
                <p className="text-xs sm:text-sm text-gray-500 label-text truncate">
                  {noteDescription}
            ...
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
              ...
              <div className="relative flex-1 sm:flex-none">
                <input
                  ...
                  className="w-full sm:w-64 pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400/30 focus:border-purple-500 transition-all duration-200 hover:border-gray-300 label-text text-sm"
                />
              ...
              {!readOnly && onEdit && (
                <>
                  ...
                  <button
                    onClick={handleEdit}
                    className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 text-gray-600 hover:text-gray-800 transition-all duration-200 hover:scale-105"
                  >
                    <Edit size={16} />
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-6 py-3 sm:py-4 h-full">
          {noteContent ? (
            <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-xl p-4 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
              ...
              <div className="overflow-y-auto h-[calc(100%-5rem)] sm:h-[calc(100%-7rem)] pr-2 sm:pr-4 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-purple-300/50 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-purple-400/50">
                <div
            ...
            <div className="text-center py-8 sm:py-12">
              <div className="p-3 sm:p-4 bg-gray-100 rounded-full w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-3 sm:mb-4 flex items-center justify-center">
                <FileText size={36} className="text-gray-400 sm:w-12 sm:h-12" />
              </div>
              <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-1 sm:mb-2 label-text">No content available</h3>
              <p className="text-sm sm:text-base text-gray-600 label-text">This note is empty.</p>
              {!readOnly && onEdit && (
                <button
                  onClick={handleEdit}
