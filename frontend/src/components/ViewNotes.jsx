...
const ViewNotes = ({ mainMaterial, material, onClose, readOnly = false, onSuccess, onEdit }) => {
  ...
  // 🔥 ADD THESE - Streak tracking state
  ...
  // 🔥 ADD THIS - Track time spent studying
  useEffect(() => {
...
const trackingInterval = setInterval(async () => {
  ...
  }, [studyStartTime, hasTrackedActivity, isActivelyReading, showToast]);
        ...
        <div className="max-w-[90rem] mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 label-text">
                  {noteDescription}
                  {/* 🔥 ADD THIS - Show study progress indicator */}
            ...
            <div className="flex items-center gap-3">
              {/* Enhanced: Search functionality with streak tracking */}
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search in note..."
                  value={searchQuery}
                  onChange={(e) => handleSearch(e.target.value)} // 🔥 CHANGED THIS
