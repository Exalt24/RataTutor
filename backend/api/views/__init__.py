...
__all__ = ["CreateConversationView", "ConversationChatView", "RetrieveConversationView", "MaterialViewSet", "NoteViewSet", "FlashcardViewSet", "AttachmentUploadView", "QuizViewSet", "QuizQuestionViewSet", "QuizGenerationView", "NoteGenerationView", "FlashcardGenerationView", "CopyMaterialView", "FlashcardSetViewSet", "AttachmentViewSet"]